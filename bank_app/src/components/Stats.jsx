    ...
    >
      {stats.map((stat, index) => (
        <motion.div
          ...
          className="flex flex-col sm:flex-row justify-center sm:justify-start items-center m-4 sm:m-6"
        >
          ...
          <p className="font-poppins font-medium xs:text-[20px] text-[16px] xs:leading-[26px] leading-[21px] text-gradient uppercase sm:ml-3 mt-1 sm:mt-0 tracking-wide">
            {stat.title}
          </p>
        </motion.div>
      ))}
